  ...
  if (lang === 'en') return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-700">Hashtag Generator processes all inputs (keywords, categories) locally. No personal data is sent to our servers unless you contact us by email.</p>
      </section>
      <section className="mb-8">
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-700">本サービス（ハッシュタグ提案ツール）は、入力されたキーワード・カテゴリ情報をブラウザ上でのみ処理します。お問い合わせメール以外に個人情報をサーバーに送信することはありません。</p>
      </section>
      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-2">2. Cookieとアクセス解析</h2>
        <p className="text-sm text-gray-700">サービス改善・広告表示のため、Google Analytics・Google AdSense等のCookieを利用する場合があります。Cookieの設定はブラウザから変更できます。</p>
      </section>
      <section className="mb-8">
